...
TODO: Describe the EBNF shortly (actual EBNF is in the appendix).\\
TODO: Note that this EBNF was not available, but we had to derive it from the parser ourselves.
