...
The document is the milestone product of the project phase 3d and contains the supporting documentation for the deliverables `analysis \& design' and `test report', as described in the project planning \citepr{plan}.
...
See \citepr{plan} for more details on the project.
