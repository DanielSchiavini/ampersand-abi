...
In the remainder of this section, other aspects of the new parser are covered: Code quality in \autoref{results:software-quality}, improved error messages in \autoref{results:errors} and the new test suite in \autoref{sec:tests}.
...
\begin{itemize}
  ...
  \item Parsec does not try to solve parsing errors.
    ...
    See also the error analysis in \autoref{results:errors}.
