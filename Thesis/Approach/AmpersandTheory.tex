...
An important classification of requirements is made by Joosten \citeac{Joosten_derivingfunctional} and Borgida \citeac{JuretaBEM10}, into early phase requirements (the business requirements), and the late phase requirements (the functional specifications). 
...
The Ampersand Methodology was crafted in 2007 by the inventor Joosten \citeac{Joosten_derivingfunctional}, with the vision to provide an answer to several of the main drawbacks of using formal techniques  in software engineering (listed in \autoref{sec:drawbacks}). 
...
The Ampersand Methodology addresses several goals to achieve this vision \citeac{Joosten_derivingfunctional}:
\begin{description}
...
In theory, the Ampersand Methodology can support any set of business rules, a language expressed in relational algebra, that satisfies the Ampersand Methodology axioms \citeac{Joosten_derivingfunctional}. 
