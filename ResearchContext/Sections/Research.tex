...
Several rules engines are built on business rules to manage the business logic used in information systems. 
...
\dict{BRMS}{Business Process Management Systems}%
