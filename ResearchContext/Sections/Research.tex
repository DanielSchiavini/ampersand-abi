...
Experiences within the Open Universiteit have shown that business analysts need roughly one hundred hours to learn how to formalize business rules using Ampersand \citeac{joosten2007deriving}.
...
Special care must be taken when using backtracking (the $try$-function), as it may negatively influence the error messages generated \citeac{parsec,try-harmful}.
