...
\label{sec:research}
By investigating the requirements defined in the project plan \citenac{plan}, we identify here two contexts in which the new Ampersand parser is implemented.
...
%todo: Reformulate this subsection
...
The syntax should be familiar, simple and concrete \citeac{lapets2009improving}.
...
Special care must be taken when using backtracking (the $try$-function) in the parsec library, as it may negatively influence the error messages generated \citenac{try-harmful} \citeac{parsec}.
