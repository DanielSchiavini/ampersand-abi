...
\dict{BRMS}{Business Rule Management System}%
Eduard Bauer \citeac{Bauer2009} makes a distinction between the domain of the Business Rules design and the use of business rules in a central repository which serves as a rule engine, a Business Rule Management system, BRMS
...
\dict{ODRES}{Output Driven Requirements Specification Method}%
\dict{BR}{Business Rules}%
\dict{BRS}{Business Rules Solution}%
Kęstutis Kapočius and Tomas Danikauskas \citeac{kapoc353} outline the use of an Output Driven Requirements Specification Method (ODRES), in combination with a Business Rules (BR), approach.
The BR approach formulates business rules in natural language using the Business Rules Solution (BRS) RuleSpeak, a model established by Ronald Ross \citeac{RuleSpeak}, which is part of the Business Rules Group.
...
Both Eduard Bauer \citeac{Bauer2009} and Kęstutis Kapočius \citeac{kapoc353} concludes that the use of business rules can simplify the analysis effort and bridge the gap between business analysts and system designers. 
