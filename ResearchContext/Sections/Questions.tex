...
But on that level is is more a mathematical exercise than a computer project.
...
But in the long run is is the form and structure of the logic itself that students need to learn to master.
}
...
Semantic Web tools such as Protégé over rich user interfaces such as GUI's for authoring data models and rules.
