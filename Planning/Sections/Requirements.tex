...
\reqtype{Main requirement: useful and user friendly error messages}
...
\reqtype{Additional functional and non-functional requirements}
...
\begin{longtable}{|>{\columncolor[HTML]{9B9B9B}}p{3cm} |p{3,5cm}|p{9,5cm}|}\hline

	\reqtype{Capability requirements}
	\req{PL-FUN-010}{Command-line interface}{Project members}{
		The NAP shall only have a command-line interface and GUI interface}

	\reqtype{Required states and modes}
	...
	\reqtype{External interface requirements}
	...
	\reqtype{Internal interface requirements}
	...
	\reqtype{Internal data requirements}
...
%		No such requirements have been identified.
	...
	\reqtype{Software quality factors}
	...
	\reqtype{Design and implementation constraints}
	...
	\reqtype{Personnel-related requirements}
%	No such requirements have been identified.

	\reqtype{Training-related requirements}
%	No such requirements have been identified.

	\reqtype{Logistics-related requirements}
%	All deliveries are done online, therefore no logistics requirements have been identified.

	\reqtype{Other requirements}
%	No such requirements have been identified.

	\reqtype{Packaging requirements}
	...
	\reqtype{Precedence and criticality of requirements}
%	No such requirements have been identified.
