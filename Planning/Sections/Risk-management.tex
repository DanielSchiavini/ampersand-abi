...
Possible impact:              & \multicolumn{5}{l|}{The features might be build incorrectly}                                                                                                                                                                                                                                      \\ \hline
...
Possible impact:              & \multicolumn{5}{l|}{Lower priority features might be build before the high priority features}                                                                                                                                                                                                                                      \\ \hline
...
Possible impact:              & \multicolumn{5}{l|}{We might deliver a parser with the same problems}                                                                                                                                                                                                                                      \\ \hline
...
Approach:                     & \multicolumn{5}{l|}{\begin{tabular}[c]{@{}l@{}}A meeting with the customer will be organized to gather\\ knowledge of the existing system, especially regarding the current issues, pain points and pitfalls.
\end{tabular}} \\ \hline
\end{tabular}
